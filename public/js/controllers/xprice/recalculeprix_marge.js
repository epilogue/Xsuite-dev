$(document).ready(function (){
    $('input.pda').change(function (){
        ...
        $('input#ra-'+k).val(ra+'%');
        var ma = Number(1 -(parseFloat($('td#cif-'+k).html()))/parseFloat($(this).val())).toFixed(2);
         $('input#ma-'+k).val(ma+'%');
    });
    $('input.ra').change(function (){
        ...
        $('input#pda-'+k).val(pda);
        var ma = Number(1-(parseFloat($('td#cif-'+k).html()))/parseFloat(Number(((100-ra)*pwp)/100).toFixed(2)));
        $('input#ma-'+k).val(parseFloat(ma)+'%');
