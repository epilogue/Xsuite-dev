    ...
    public function createAction() {
		...
		$agreement3 = "I000003";
               // var_dump($itnoarticle);
                $query3 = "select * from EIT.MVXCDTA.MPAGRP MPAGRP where MPAGRP.AJCONO = '$mmcono' AND MPAGRP.AJSUNO = '$supplier' AND (MPAGRP.AJAGNB = '$agreement3'  OR MPAGRP.AJAGNB = '$agreement2' OR MPAGRP.AJAGNB = '$agreement1') AND MPAGRP.AJOBV2 = '$itnoarticle' AND MPAGRP.AJOBV1 = '$division'  ORDER BY MPAGRP.AJAGNB";
echo $query3;
//exit();
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($formData)) {
                ...
                foreach ($this->view->resultat as $resultarticle) {
                    ...
                    $demande_xprice = $demandes_xprice->createDemandeArticlexprice($resultarticle['OBSAPR'], $resultarticle['OBNEPR'], $resultarticle['OBORQT'], round($resultarticle['OBNEPR'] * 100 / $resultarticle['OBSAPR'], 2), $infos_offres->OBRGDT, null, null, null, null, null, $trackingNumber, $resultarticle['OBITNO'], $resultarticle['OBITDS'], $numwp);
                }
