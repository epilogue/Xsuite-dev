...
//            echo '<pre>',  var_export($article_info),'</pre>'; exit();
        ...
        $defxdistrib = $Defxdistribs->createXDistrib($numwp, $trackingNumber,$context_info[0]['contexte_demande'],$date,$context_info[0]['services_associes'],134,$infos_dd->id_user,null,$infos_offres->OBDLSP,$numwp_distributeur5);
