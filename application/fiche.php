...
Fax : </p>
          ...
          <div class="Style11" id="Layer9">
            ...
            <p align="left" class="Style3 ">- N’envoyez aucun  produit avant d’avoir obtenu un numéro de RMA, sinon le produit vous sera réexpédié.</p><br/>

<p align="left" class="Style3 ">-Le produit défectueux doit parvenir au siège de SMC-France à Bussy Saint Georges dans un délai maximum de 1 semaine après attribution du numéro de RMA. </p>
            <p align="left" class="Style3 ">- <p>
          </div>
          <p class="Style9"><br>
          </p>
          <div> 
		<p align="left" class="Style3 " style="font-style:italic">-Ce produit est la propriété du client, ce dernier ne peut être remis en stock par SMC. </p><br/><br/>
		<p align="left" class="Style3 " style="font-style:italic">-En renvoyant son produit, le client accepte que celui-ci soit testé et démonté par SMC dans le cadre d’un diagnostic technique. Si le dysfonctionnement du produit est avéré, le produit sera réparé ou remplacé au titre de la garantie. Si le défaut est lié à une cause extérieure non pris en charge par la garantie, le produit défectueux pourra, sur demande, vous être retourné en l’état et à vos frais dans un délai de 2 mois maximum après réception du rapport d’expertise. Au-delà de ce délai, le produit sera détruit par SMC.</p><br/><br/>
		<p align="left" class="Style3 " style="font-style:italic">-Si l'expertise ne révèle aucun dysfonctionnement propre au produit, celui-ci vous sera renvoyé et il sera alors procédé à la facturation des frais d'envoi A/R, selon nos Conditions Générales de Ventes, dans le cas d'un retour sous garantie.</p><br/><br/>
