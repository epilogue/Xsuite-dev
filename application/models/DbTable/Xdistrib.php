...
class Application_Model_DbTable_Xdistrib extends Zend_Db_Table_Abstract {
    ...
    public function searchByUser($id){
        $sql="select demande_xdistrib.id_demande_xdistrib,validations_demande_xdistrib.nom_validation,distributeurs.nom_distributeur, demande_xdistrib.num_workplace_demande_xdistrib,demande_xdistrib.tracking_number_demande_xdistrib,client_distrib.nom_client,demande_xdistrib.date_demande_xdistrib,validations_demande_xdistrib.etat_validation from demande_xdistrib "
                ...
                . " where demande_xdistrib.id_user =$id order by demande_xdistrib.id_demande_xdistrib desc";
