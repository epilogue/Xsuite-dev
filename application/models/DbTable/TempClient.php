...
class Application_Model_DbTable_TempClient extends Zend_Db_Table_Abstract {
   ...
   public function truncateAll(){
       $query = "TRUNCATE TABLE temp_client,temp_fichier_contexte,temp_fichier_distrib_article,temp_fichier_distrib_info,temp_fichier_distrib_prix_concurrent,temp_movex_demande,temp_movex_distrib,temp_movex_offre ";
