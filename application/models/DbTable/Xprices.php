...
public function searchAll($tracking_number){
    ...
    public function searchByUser($id){
        $sql="select demande_xprices.num_workplace_demande_xprice,demande_xprices.tracking_number_demande_xprice,clients.nom_client,demande_xprices.date_demande_xprice from demande_xprices "
