...
class Application_Model_DbTable_HierarchieXprev extends Zend_Db_Table_Abstract {
    ...
    public function affichehierarchienord(){
        $sql = "select users.nom_user,fonctions.nom_fonction, holons.nom_holon from hierarchie_xprev "
                . "left join users on users.id_user = hierarchie_xprev.id_user "
                . " left join holons on holons.id_holon = user.id_holon "
                . " left join fonctions on fonctions.id_fonction= user.id_fonction "
